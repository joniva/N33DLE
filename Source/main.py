#This file will be used for creating the main functions of the injector
import psutil
import subprocess
...
#Injection method belongs to: https://github.com/numaru
class Injector:
...
#Assigns the path of the dll to path_dll

def fetchPATH():

    global path_dll
    path_dll = askopenfilename()
    entry_text2.set(path_dll)
    but2.configure(state="disabled")
    but3.configure(state="active")
